<template>
    <form @submit.prevent="createAccount">
        <h2 class="text-danger d-block" v-if="response.message">
            {{ response.message }}
        </h2>
        <div class="row g-3">
            <div class="col">
        ...
        <div class="col-12">
            ...
            <div
                class="invalid-feedback d-block"
                v-if="response.errors && response.errors.nick"
            >
        ...
        <div class="col-12">
            ...
            <div
                class="invalid-feedback d-block"
                v-if="response.errors && response.errors.email"
            >
        ...
        <div class="col-12">
            ...
            >
                <p
                    v-for="error in response.errors.password_confirmation"
                    :key="error"
                >
                    {{ error }}
                </p>
...
export default {
    ...
    setup() {
        ...
        const createAccount = () => {
            ...
            if (letRegister) {
                store
                    .dispatch("register", localUserData.value)
                    .then((res) => {
